...
const RunningLanding = () => {
  ...
  useEffect(() => {
    ...
    script.innerHTML = `
      ...
      fbq('init', '836936292385216');
      fbq('track', 'PageView');
    `;
    document.head.appendChild(script);

    const noscript = document.createElement('noscript');
    noscript.innerHTML = `<img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=836936292385216&ev=PageView&noscript=1" />`;
  ...
  return (
    <>
      <Helmet>
        <title>Método SDC - Corra Sem Dores e Quebre Seus Recordes</title>
        <meta name="description" content="Fortaleça, previna e trate lesões da corrida de forma simples. O ajuste biomecânico que já salvou mais de 9.000 corredores." />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start max-w-4xl mx-auto">
              ...
              <Card className="order-2 border-4 border-blue-500 shadow-2xl relative bg-white flex flex-col z-10 overflow-visible">
                ...
                <CardContent className="text-center pt-6 flex flex-col">
                  ...
                  <a href="https://pay.lowify.com.br/checkout.php?product_id=phc7ku" className="w-full no-underline">
