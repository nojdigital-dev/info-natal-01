      ...
      <DialogContent className="w-[95%] max-w-[425px] p-0 overflow-hidden rounded-3xl border-4 border-yellow-400 shadow-2xl bg-white mx-auto font-sans">
        <DialogHeader className="p-6 pb-0 text-center bg-blue-600">
          ...
          <DialogDescription className="text-blue-100 text-base md:text-lg pt-2 leading-snug font-medium">
            Mães inteligentes não levam o básico. Leve o <span className="font-black text-yellow-300">KIT COMPLETO (+6 Bônus)</span> com um desconto secreto agora.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="p-6 pt-4 text-center">
          <div className="my-4 bg-yellow-50 p-4 rounded-xl border-2 border-yellow-400 relative overflow-hidden shadow-sm">
            ...
            <p className="text-xs md:text-sm text-slate-400 mb-1 line-through font-bold">De R$ 25,00</p>
          ...
          <div className="space-y-2 mb-6 text-left">
             ...
             <div className="flex items-center gap-2 text-xs md:text-sm text-slate-700 font-bold bg-slate-50 p-2 rounded-lg border border-slate-100">
                <Star size={16} className="text-yellow-500 shrink-0"/> 6 Cadernos de Bônus (Jogos e Alfabeto)
             </div>
          </div>
          ...
          >
            ...
            <span className="text-xs font-normal opacity-90 tracking-wide uppercase">Adicionar por apenas R$ 3,00 a mais</span>
          </Button>
          ...
          >
            Não obrigado. Vou perder essa oportunidade e levar o kit básico incompleto por R$ 17,00.
          </Button>
        </div>
      </DialogContent>
    </Dialog>
