...
const PetRecipesLanding = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Receitas Naturais para Pets - Saúde e Longevidade</title>
        <meta name="description" content="Devolva a energia do seu melhor amigo com receitas naturais, simples e baratas. Aprovado por veterinários." />
      ...
      <div className="min-h-screen bg-white font-sans text-slate-900 overflow-x-hidden">
        ...
        <section className="relative bg-gradient-to-br from-green-700 via-green-600 to-green-800 text-white py-8 md:py-24 px-4 overflow-hidden">
          ...
          <div className="absolute inset-0 pointer-events-none overflow-hidden">
            ...
            <Bone className="absolute top-60 right-[10%] text-orange-200 animate-pulse opacity-40" size={35} /> 
